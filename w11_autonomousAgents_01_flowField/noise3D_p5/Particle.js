...
class Particle {
  ...
  applyNoise3D() {
    ...
    let noiseFreq = 0.01;
    let freqX = (this.pos.x + frameCount) * noiseFreq;
    let freqY = (this.pos.y + frameCount) * noiseFreq;
    let freqZ = (this.pos.z + frameCount) * noiseFreq;
    let noiseValue = map( noise(freqX, freqY, freqZ), 0, 1, -1, 1);
    ...
    // feel free to adjust the magnitude (0.1)
    vector.mult(noiseValue*0.1);
